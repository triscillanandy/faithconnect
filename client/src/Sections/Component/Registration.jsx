...
function Registration({ text }) {
  ...
  return (
    <div className="flex p-16 gap-20 container mx-auto max-loginScreen1:flex-col-reverse max-loginScreen1:p-4">
         ...
         {/* Left Section */}
        <div className="hidden md:flex h-[700px] w-full md:w-[600px] flex-col justify-center items-center relative">
  ...
  <div className="flex absolute bottom-2 left-1">
    ...
    <p className="font-bold text-2xl sm:text-3xl md:text-4xl flex items-center pl-16">
      <img src={Pray} alt="Pray" className="w-[50px] h-[50px] mr-2" /> {/* Smaller icon */}
      <span className="">Faith<span className="text-[#FF6132]">Connect</span></span>
    </p>
  </div>
        {/* Close Icon - Hidden on Mobile */}
        <div className="absolute top-0 right-0 mt-4 px-3 hidden md:flex">
  ...
  <p>Fill in the information to continue.</p>
          ...
          <div className="flex justify-between gap-4 mt-1 flex-col md:flex-row">
  <input
    type="text"
